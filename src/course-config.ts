...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP2186",
  title: "The Science of Guitar Tone",
  session: "Semester 1",
  year: 2027,
  level: 2,
  ...
  endDate: "2027-05-28",
  description:
    "How a vibrating guitar string becomes the sound recognised as electric " +
    "guitar tone, followed as one engineering system: string, pickup, " +
    "circuit, gain stage, filter, amplifier, speaker and the ear, each week " +
    "tracing what changed physically into what changed audibly.",
  tags: ["acoustics", "signal processing", "electronics"],
